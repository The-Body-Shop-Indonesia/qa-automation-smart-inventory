  ...
  //Before Stock Movement Condition
      cy.api({
          ...
          if (!latestStock) {
            ...
            cy.log(`SKU 134070359 at from store 14160 - Previous totalStock: ${Before_latestStock_Movement}, Current totalStock: ${totalStock}`);
...
expect(stockSummary.length).to.be.lte(1, 'Jumlah dokumen dalam stock summary tidak boleh lebih dari 1');
        ...
        if (!latestStock) {
            ...
            cy.log(`SKU 134070359 at from store 14160 - Previous totalStock: ${Before_latestStock_Summary}, Current totalStock: 0`);
          } else {
  ...
  cy.api({
      ...
      qs: {
        ...
        throw new Error('No stock movement data found for SKU 134070359 at from store 14160 with UBD 2025-05');
        }
    ...
    cy.api({
        ...
        qs: {
            ...
            if (!latestStock) {
                ...
                throw new Error('No stock data found for SKU 134070359 at store 14160 with UBD 2025-05');
            }
