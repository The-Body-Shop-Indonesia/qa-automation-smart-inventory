...
describe('General API Test Group', () => {
  ...
  it('Should be able to access the API with valid token', () => {
    ...
    it('Should return error 401 if access the API with invalid token', () => {
    ...
    it('Should return error 401 if access the API without token', () => {
        const invalidToken = ''
        cy.api({
            method: "GET",
            url: url + '/'+Cypress.env('stockSummaryId'),
  ...
  it('Should get stock summary details', () => {
    ...
    it("Should return error 400 if id is invalid", () => {
